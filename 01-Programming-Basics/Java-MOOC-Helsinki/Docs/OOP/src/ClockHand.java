public class ClockHand {
  ...
  // khác thì sao, ta chỉ cần tạo ra 3 cây kim và cho chúng các giới hạn. -> Reusability +
  // Modularity

  // Về mặt Object ta phân rã chúng ở khi tạo ra một instance cụ thể, nhưng ở Class, ta gom chung nó
  // lại để
  // thực hiện một hành động cụ thể. Có nghĩa là Object có các hành vi như nhau, nhưng quy luật
  // trạng thái
  ...
  // Từ đây ta có thể kết luận, một chương trình có thể được tạo ra từ các đối tượng, mỗi đối tượng
  // có nhiệm
